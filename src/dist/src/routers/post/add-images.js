...
router.post('/post/:id/add/images', src_1.uploadImages, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, images, imagesArray, Post;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                imagesArray = images.map(function (file) {
                ...
                return [4 /*yield*/, post_1.default.findOneAndUpdate({ _id: id }, { $push: { images: { $each: imagesArray } } }, { new: true })];
            case 1:
                Post = _a.sent();
