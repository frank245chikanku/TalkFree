...
router.get('/api/post/show/:id?', function (req, res, next) {
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var id, allPosts, post, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    allPosts = _a.sent();
                    return [2 /*return*/, res.status(200).json({ posts: allPosts })];
                case 2: return [4 /*yield*/, post_1.default.findById(id).populate('comments')];
                case 3:
                    post = _a.sent();
                    if (!post) {
