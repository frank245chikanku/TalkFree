...
router.post('/api/post/update/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, content, title, error, updatedPost, error, err_1, error;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, post_1.default.findOneAndUpdate({ _id: id }, { $set: { content: content, title: title } }, { new: true })];
            case 2:
                updatedPost = _b.sent();
                if (!updatedPost) {
